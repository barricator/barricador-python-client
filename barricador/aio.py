"""Asyncio-native Barricador server SDK client.
...
logger = logging.getLogger("barricador.aio")


class AsyncBarricadorClient:
    def __init__(
        self,
        sdk_key: str,
    ...
    async def __aenter__(self) -> "AsyncBarricadorClient":
        await self.start()
        return self
